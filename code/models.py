...
class Paper(object):
	...
	def get_questions(self, source='mine'):
		...
		# questions = [r+q for r,q in zip(questions[::2], questions[1::2])] # Put the delimeters back in
		# assert len(questions) == self.n_questions, 'The wrong number of questions was found ({} not {})'.format(len(questions), self.n_questions)
